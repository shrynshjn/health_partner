...
export class GoalsService {
  ...
  async get(userId: string) {
    ...
    return { goals: doc.goals, updatedAt: doc.updatedAt.toISOString() };
  }
  ...
  async update(userId: string, dto: UpdateGoalsDto) {
    ...
    return { message: 'Goals updated successfully', updatedAt: updated.updatedAt.toISOString(), updated: updated.goals.length };
  }
}
